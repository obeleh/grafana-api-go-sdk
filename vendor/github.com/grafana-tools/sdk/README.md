...
# Grafana SDK [![Go Report Card](https://goreportcard.com/badge/obeleh/grafana-api-go-sdk)](https://goreportcard.com/report/obeleh/grafana-api-go-sdk)
...
## Examples [![GoDoc](https://godoc.org/obeleh/grafana-api-go-sdk?status.svg)](https://godoc.org/obeleh/grafana-api-go-sdk)
...
Of course Go development environment should be set up first. Then:
	...
	go get obeleh/grafana-api-go-sdk
...
https://obeleh/grafana-api-go-sdk
